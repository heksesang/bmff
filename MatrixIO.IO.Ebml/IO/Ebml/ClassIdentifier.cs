...
{
    public readonly struct ClassIdentifier : IEquatable<ClassIdentifier>, IComparable<ClassIdentifier>
    {
        ...
        public override int GetHashCode() => _classIdentifier.GetHashCode();
